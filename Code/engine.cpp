...
void Init(App* app)
{
	...
	app->whiteTexIdx = LoadTexture2D(app, "white.png");
	app->blackTexIdx = LoadTexture2D(app, "black.png");
	app->normalTexIdx = LoadTexture2D(app, "normal.png");
	app->magentaTexIdx = LoadTexture2D(app, "magenta.png");
    */

    // Patrick Load
	app->texturedMeshProgramIdx = LoadProgram(app, "RENDER_GEOMETRY.glsl", "RENDER_GEOMETY");
	Program& texturedMeshProgram = app->programs[app->texturedMeshProgramIdx];
	app->texturedMeshProgram_uTexture = glGetUniformLocation(texturedMeshProgram.handle, "uTexture");
	ModelHelper::LoadModel(app, "Patrick/Patrick.obj");
